...
Authors: Nicolas Carion glyph[star] , Francisco Massa glyph[star] , Gabriel Synnaeve, Nicolas Usunier, Alexander Kirillov, and Sergey Zagoruyko
...
# Backbone. 
Starting from the initial image x img ∈ R 3 × H 0 × W 0 (with 3 color channels 2 ), a conventional CNN backbone generates a lower-resolution activation map f ∈ R C × H × W . Typical values we use are C = 2048 and H,W = H 0 32 , W 0 32 .
...
|-----------------------|--------------|-----------|------|---------|---------|--------|--------|--------|
| Faster RCNN-DC5       | 320/16       | 166M      | 39   |    60.5 |    42.3 |   21.4 |   43.5 |   52.5 |
| Faster RCNN-FPN       | 180/26       | 42M       | 40.2 |    61   |    43.8 |   24.2 |   43.5 |   52   |
| Faster RCNN-R101-FPN  | 246/20       | 60M       | 42   |    62.5 |    45.9 |   25.2 |   45.6 |   54.6 |
| Faster RCNN-DC5+      | 320/16       | 166M      | 41.1 |    61.4 |    44.3 |   22.9 |   45.9 |   55   |
| Faster RCNN-FPN+      | 180/26       | 42M       | 42   |    62.1 |    45.5 |   26.6 |   45.4 |   53.4 |
| Faster RCNN-R101-FPN+ | 246/20       | 60M       | 44   |    63.9 |    47.8 |   27.2 |   48.1 |   56   |
| DETR                  | 86/28        | 41M       | 42   |    62.4 |    44.2 |   20.5 |   45.8 |   61.1 |
| DETR-DC5              | 187/12       | 41M       | 43.3 |    63.1 |    45.9 |   22.5 |   47.3 |   61.1 |
| DETR-R101             | 152/20       | 60M       | 43.5 |    63.8 |    46.4 |   21.9 |   48   |   61.8 |
...
Table 4: Effect of loss components on AP. We train two models turning off glyph[lscript] 1 loss, and GIoU loss, and observe that glyph[lscript] 1 gives poor results on its own, but when combined with GIoU improves AP M and AP L . Our baseline (last row) combines both losses.

| class        | glyph[lscript] 1   | GIoU         |   AP | ∆    |   AP 50 | ∆    |   AP S |   AP M |   AP L |
|--------------|--------------------|--------------|------|------|---------|------|--------|--------|--------|
| glyph[check] | glyph[check]       | glyph[check] | 35.8 | -4.8 |    57.3 | -4.4 |   13.7 |   39.8 |   57.9 |
| glyph[check] |                    |              | 39.9 | -0.7 |    61.6 | 0    |   19.9 |   43.2 |   57.9 |
| glyph[check] | glyph[check]       | glyph[check] | 40.6 | -    |    61.6 | -    |   19.9 |   44.3 |   60.2 |
...
| UPSnet        | R50        | 42.5 | 78   | 52.5 |    48.6 |    79.4 |    59.6 |    33.4 |    75.9 |    41.7 | 34.3 |
| UPSnet-M      | R50        | 43   | 79.1 | 52.8 |    48.9 |    79.7 |    59.7 |    34.1 |    78.2 |    42.3 | 34.3 |
| PanopticFPN++ | R101       | 44.1 | 79.5 | 53.3 |    51   |    83.2 |    60.6 |    33.6 |    74   |    42.1 | 39.7 |
| DETR          | R50        | 43.4 | 79.3 | 53.8 |    48.2 |    79.8 |    59.5 |    36.3 |    78.5 |    45.3 | 31.1 |
| DETR-DC5      | R50        | 44.6 | 79.8 | 55   |    49.4 |    80.5 |    60.6 |    37.3 |    78.7 |    46.5 | 31.9 |
| DETR-R101     | R101       | 45.1 | 79.9 | 55.5 |    50.5 |    80.9 |    61.7 |    37   |    78.5 |    46   | 33   |
...
Box loss Similarly to [41,36], we use a soft version of Intersection over Union in our loss, together with a glyph[lscript] 1 loss on ˆ b :

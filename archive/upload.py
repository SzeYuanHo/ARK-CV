...
# Function to upload a Markdown file and append to vault.txt
def upload_mdfile():
    ...
    if file_path:
        with open(file_path, 'r', encoding="utf-8") as md_file:
            ...
            print(f"Markdown file content appended to vault.txt with each chunk on a separate line.")
...
# Create a button to open the file dialog for Markdown file
md_button = tk.Button(root, text="Upload Markdown File", command=upload_mdfile)

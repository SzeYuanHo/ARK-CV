...
1 Max Planck Institute of Molecular Cell Biology and Genetics, Dresden, Germany Center for Systems Biology Dresden, Germany

2 Faculty of Computer Science, Technical University Dresden, Germany
...
3 Although we only consider the single object class cell nuclei in our experiments, note that we are not limited to that and thus use the generic term object in the following.
...
are weighted more, which is appropriate since these will be favored during nonmaximum suppression. The code is publicly available 4 .
...
6. He, K., Gkioxari, G., Doll´ ar, P., Girshick, R.: Mask R-CNN. In: ICCV (2017)
...
10. Ma, J., Shao, W., Ye, H., Wang, L., Wang, H., Zheng, Y., Xue, X.: Arbitraryoriented scene text detection via rotation proposals. IEEE Transactions on Multimedia (2018)
...
17. Ulman, V., Maˇ ska, M., Magnusson, K.E., Ronneberger, O., Haubold, C., Harder, N., Matula, P., Matula, P., Svoboda, D., Radojevic, M., et al.: An objective comparison of cell-tracking algorithms. Nature methods 14 (12), 1141 (2017)
18. Ulman, V., Or´ emuˇ s, Z., Svoboda, D.: TRAgen: a tool for generation of synthetic time-lapse image sequences of living cells. In: ICIAP (2015)

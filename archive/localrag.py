...
def get_relevant_context(rewritten_input, vault_embeddings, vault_content, top_k=5):
    ...
    # Adjust top_k if greater than available entries
...
def rewrite_query(user_input_json, conversation_history, llm_model):
...
def ollama_chat(user_input, system_message, vault_embeddings, vault_content, llm_model, conversation_history):
    ...
    if len(conversation_history) > 1:
        ...
        rewritten_query_json = rewrite_query(json.dumps(query_json), conversation_history, llm_model)

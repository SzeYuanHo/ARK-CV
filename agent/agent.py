...
async def graph_search(
    ...
    """
    Search the knowledge graph for facts and relationships. Best for finding specific facts,
    relationships between papers/architectures, and time-based information.

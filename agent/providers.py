...
def get_vlm_client() -> openai.AsyncOpenAI:
    """
    Get VLM (Vision Language Model) client configuration.
    
    Returns:
        Configured OpenAI-compatible client for vision tasks
    """
...
def get_vlm_model() -> str:
    """
    Get VLM model name from environment.
    
    Returns:
        VLM model name
    """
    return os.getenv('VLM_MODEL', 'gpt-4o')
